...
- **개인화된 기업 분석 체크리스트**: 사용자의 투자 성향(보수적/공격적)에 맞춰 PER, 베타, 부채비율, 매출 성장률 등 다양한 재무 지표를 종합적으로 분석하는 맞춤형 체크리스트를 제공합니다.
- **자동 리디렉션**: 로그인된 사용자가 초기 페이지에 접속하면, 대시보드로 자동 이동하여 즉시 서비스를 이용할 수 있습니다.
...
# Alpha Vantage API Key (기업 상세 재무 정보 조회용)
